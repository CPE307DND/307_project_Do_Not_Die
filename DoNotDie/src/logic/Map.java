...
public class Map
{
	public Map ()
	{
		...
		layout [0] = new Room (0, 0, 5, -1, 8, -1, 1, -1, 2);
		layout [1] = new Room (0, 0, 5, -1, 0, -1, -1, -1, 4);
		layout [2] = new Room (2, 0, 5, -1, -1, -1, 3, 0, -1);
		layout [3] = new Room (1, 0, 5, -1, 2, -1, 4, 5, -1);
		layout [4] = new Room (0, 0, 5, -1, 3, -1, -1, 1, -1);
		layout [5] = new Room (0, 0, 5, -1, -1, -1, 6, 13, 3);
		layout [6] = new Room (0, 0, 5, 7, 5, -1, -1, -1, -1);
		layout [7] = new Room (0, 0, 5, -1, -1, 6, -1, -1, -1);
		layout [8] = new Room (1, 0, 5, -1, 9, -1, 0, -1, 10);
		layout [9] = new Room (0, 0, 5, -1, -1, -1, 8, -1, 11);
		layout [10] = new Room (1, 0, 5, -1, 11, 12, -1, 8, -1);
		layout [11] = new Room (1, 0, 5, -1, -1, -1, 10, 9, -1);
		layout [12] = new Room (2, 0, 5, 10, -1, -1, -1, -1, -1);
		layout [13] = new Room (2, 0, 5, -1, -1, -1, -1, -1, 5);
